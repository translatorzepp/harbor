...
LOG_FILE_INFO = 'graphitewebinfo.log'
LOG_FILE_EXCEPTION = 'graphitewebexception.log'
LOG_FILE_CACHE = 'graphitewebcache.log'
LOG_FILE_RENDERING = 'graphitewebrendering.log'
